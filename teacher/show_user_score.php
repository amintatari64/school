...
<html lang="fa" dir="rtl">
  ...
  <body>
      <div class="container mt-5 d-flex flex-column justify-content-center align-items-center">
        <h1 class="border rounded mb-5 p-4 rounded-pill bg-warning bg-opacity-25 shadow-sm px-5">نمرات دانش آموز <?php echo $name; ?></h1>
        <?php
        if(isset($_POST['show_score']) and isset($_POST['lesson']) and !isset($_GET['hide_score'])){
         ?>
         ...
         <?php
          ...
          <a href="edit_user_score.php?fname=<?php echo $fname."&lname=".$lname."&code=".$code."&class=".$class; ?>" class="btn btn-primary shadow-sm">ویرایش نمرات</a>
           <?php
        }
        ?>
        ...
        ?>
        <a href="usercontrol.php?show_user=1" class="btn btn-outline-danger px-3 shadow-sm  d-block">بازگشت</a>
    </div>
